(function ($) {
    ...
    $.fn.jbvalidator = function (options) {
        ...
        let errorMessages = {
            maxValue: "O campo deve ter no minimo %s carateres ou menos",
            minValue: "Value must be greater than or equal to %s.",
            maxLength: "O campo deve ter no minimo %s carateres ou menos (you are currently using %s characters).",
            minLength: "O campo deve ter no minimo %s carateres ou mais (you are currently using %s characters).",
            ...
            equal: "As senhas digitadas sao iguais %s field.",
            ...
            HTML5: {
                valueMissing: {
                    INPUT: {
                        ...
                        checkbox: "Seleciona este campo",
                        radio: "Seleciona uma das opnioes",
                        file: "Seleciona um ficheiro de imagem"
                    },
                    SELECT: "Seleciona uma das opçoes",
                    TEXTAREA: "Escreva algum texto "
                },
                typeMismatch: {
                ...
                tooLong: "Este campo deve ter no minimo %s ou mais (fatam %s carateres).",
                tooShort: "Este campo deve ter no minimo %s carateres ou mas (digitou %s carateres).",
                patternMismatch: "",
                badInput: {
                    number: "Please enter a number."
                }
