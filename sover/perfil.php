...
<body id="page-top">
    ...
    <div class="main-body">
          ...
          <div class="row">
              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-start">
                    <img src="util/buscar_foto.php?id=<?= $_SESSION['foto'];?>"  class="rounded-circle" width="150">
                  </div>
                    ...
                    <div class="mt-3">
                      <h5>
                       ...
                       <p>
                                 ...
                                 <p>
                                 <?php echo "Numero Universitario: ".$num_univer; ?></p>
            ...
            $sq="SELECT * FROM resultado_eleicao WHERE num_bi='{$_SESSION['id']}'";  
            ...
            ?>
              ...
              <div class="card shadow">
               ...
               <h5><strong class="text-primary"> Eleiçoes a conconcorrer </strong></h5>
                 </div>
                 <div class="card-body">
                                     ...
                                     while($dados=mysqli_fetch_assoc($resulta)){
                                         ...
                                         ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php echo $dados['data_inicio'];?>
                                                </td>
                                                <td>
                                                    <?php echo $dados['hora_inicio'];?>
                                                </td>
                                                 <td>
                                                    <?php echo $dados['hora_final'];?>
                                                </td>
                                                <td>
                                                    <?php 
                                                     if($dados['estado']==3){
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <div class="card shadow mb-3">
                                    <div class="card-header py-3">
                                        <p class="text-primary m-0 fw-bold"><h2 class="text-primary"> perfil</h2></p>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="form-floating"><input class="form-control" name="primeiro_nome" type="text" placeholder="" name="primeiro_nome" value="<?= $primeiro_nome; ?>" disabled>
                                                  <label class="form-label" for="floatingInput"><strong>Primeiro Nome</strong></label>
                                              </div>
                                          </div>
                                          <div class="col-lg-4">
                                             <div class="form-floating">
                                                <input class="form-control" type="text" id="Ultimo_nome" placeholder="Doe" name="ultimo_nome" value="<?= $segundo_nome; ?>"disabled>
                                               
                                              <label for="floatingPassword"> <strong>Sobrenome</strong></label></div></div>
                                              <div class="col-lg-4">
                                                <div class="form-floating">

                                                    <input class="form-control" name="email" type="email" id="email" placeholder="user@example.com" name="email" value="<?= $email; ?>"disabled>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-7">
                                            <div class="form-floating">
                                                <input class="form-control" type="text" id="endereco" placeholder="Hortencio de sousa" name="endereco" value="<?= $endereco; ?>" disabled>
                                          ...
                                          <div class="col">
                                           ...
                                           <div class="form-floating">  
                                            <input class="form-control form-control" type="text" id="telemovel" name="telemovel" value="<?= $contacto; ?>" disabled>
                                  ...
                                  <div class="row">
                                    <div class="col">
                                        ...
                                        <select class="d-inline-block form-select form-control" id="provincia_nascimento" name="provincia_nascimento"disabled>
                                           
                                           <option value="
                                           <?=$dad['id_prov']; ?>">
                                            <?php echo $dad['nom_prov']; ?></option>
                                         </select>
                                         <label for="floatingSelect" class="form-floating">Provincia Nascimento</label> 
                                       </div>
                                  ...
                                  <div class="col">
                                        ...
                                        <select class="d-inline-block form-select form-control" id="provincia_nascimento" name="provincia_nascimento"disabled>
                                           ...
                                           <option value="<?=$dad['id_mun'];?>"><?php echo $dad['nom_mun'];?></option>
                                         </select>
                                         <label for="floatingSelect" class="form-floating">Municipio Nascimento</label> 
                          ...
                          <div class="row">
                            ...
                            <div class="form-control">
                                    ...
                                    <input class="form-control" type="date" id="data_nascimento" placeholder="Data Nascimento" name="data_nascimento" value="<?= $data_n; ?>" disabled>
                          ...
                          <div class="col-lg-4">
                              ...
                              <div id="dataTable_length" class=" dataTables_length" aria-controls="dataTable">
                                ...
                                <select class="d-inline-block form-select form-select-sm" id="sexo" name="sexo" disabled>
                          ...
                          <div class="col-lg-8 align-items-center">
                             ...
                             <div class="col-lg-8 align-items-center">
                                <a href="editar_perfil.php" class="btn btn-primary" id="salvar_alterado" value="salvar_alterado" name="salvar_alterado" type="submit">Editar perfil</a></div>
                            </div>
                        </div>
                    </div>
                </div>
