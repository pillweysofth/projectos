                ...
                <div class="container-fluid">
                    <div class="card shadow">
                        <div class="card-header">
                            <div class="row">
                            <div class="col">
                            <h2 class="text-dark mb-0" style="color: var(--bs-purple);text-align: center;"><strong>ADMINISTRADOR DO SISTEMA</strong></h2>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-control">
                                <label class="form-label">Eleiçao</label>
                                <select class="form-select" name="eleicao" id="eleic" required>
                               <option value="">Seleciona a eleicao</option>
                               <?php
                                $sql="SELECT * FROM eleicao";
                                $result=mysqli_query($conn,$sql);
                                while($elei=mysqli_fetch_assoc($result)){
                                    if((int)$elei['estado']===3){
                                    echo
                                    "<option value='{$elei['id_elei']}'>{$elei['titulo']}</option>";
                                }
...
<script src="../assets/js/theme.js"></script>
    ...
    <script type="text/javascript">
        ...
        function listar_usuario(pagina, qnt_result_pg){
                $("#dad").load("../bd/dados.php?pagina="+pagina+"&qntd="+qnt_result_pg+"&elei="+$("#eleic").val());
            }
          $(function(){
            $("#eleic").change(function(){
               $("#dad").load("../bd/dados.php?pagina="+pagina+"&qntd="+qnt_result_pg+"&elei="+$("#eleic").val());
            })
        })
