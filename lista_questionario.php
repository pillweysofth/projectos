                ...
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-start">
                   <?php echo $row_quest['sobre'];?>
                    ...
                    <a href="responder_questionario.php?id_quest=<?=$row_quest['id_questionario']; ?>" type="button" class="btn btn-outline-info"> Participar </a>
                    <a href="resultado_questionario.php?id_quest=<?=$row_quest['id_questionario']; ?>" type="button" class="btn btn-outline-primary"> Resultado</a>
                       </div>
                  </div>
