                    ...
                    <li class="nav-item">
                        <div><a class="btn btn-link nav-link" data-bs-toggle="collapse" aria-expanded="false" aria-controls="collapse-3" href="#collapse-3" role="button"><i class="far fa-user"></i>&nbsp;<span style="font-weight: bold;">Usuario</span></a>
                            <div class="collapse" id="collapse-3">
                                <div class="bg-white border rounded shadow flex-fill py-2 collapse-inner"><a class="collapse-item" href="perfil.php" style="transform: translate(0px);"><i class="fas fa-user-plus"></i>&nbsp;Perfil</a><a class="collapse-item" href="registar_usuario.php"><i class="fas fa-user-tie"></i>&nbsp; Usuarios registados</a></div>
                            </div>
                        </div>
                                           </li>
            ...
            <div id="content">
                <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top" style="background: url(&quot;../assets/img/5.jpg&quot;) center / cover;">
                    ...
                    while($row_eleicao = mysqli_fetch_assoc($resultado)){
                        if(((int)$row_eleicao['estado']==3)&&($row_eleicao['data_fim']>=strtotime("today"))){
                            ...
                            <div class="card shadow border-start-info py-2">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            <div class="text-uppercase text-center fw-bold mb-1"><strong><?php
                                           echo $row_resultado['nome']; ?></strong></div>
                                            <div class="row g-0 align-items-center">
                                                <div class="col-auto">
                                                    <div class="col-auto align-items-center"><img class="border rounded-circle img-profile" src="../util/buscar_foto.php?id=1>" width="100" height="100"></div>
                                                </div>
                                                <div class="col">
                                                     <div class="progress">
