                    ...
                    <div class="container shadow">
                        <div class="card">
                            <div class="card-header align-items-center">
                                <h3>  <strong class="text-primary text-center"> LISTA DE QUESTIONARIOS </strong> </h3>
                            </div>
...
while ($row_quest = mysqli_fetch_assoc($resultado)) {
    ?>

                                        <div class="col-lg-4" id="mini-banners">

                                            <div class="col-lg-10 offset-1">
                                                <div class="card shadow">
                                                    <div class="card-header ">
                                                        <h2>    <?php echo $row_quest['nome_quest']; ?></h2>
                                                    </div>

                                                    <div class="card-body">
                                                        <div class="d-flex flex-column align-items-center text-start">
    <?php echo $row_quest['sobre']; ?>
                                                        </div>
                                                    </div>
