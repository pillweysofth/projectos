     ...
     $sql="SELECT * FROM eleicao WHERE id_elei='{$_GET['id_elei']}'";
                            ...
                            <div class="card shadow mb-3">
                                 <div class="card-header py-3 align-items-center">
                                    <p class="text-primary m-0 fw-bold " style="color: var(--bs-purple);text-align: center;">
                                        <strong> ADICIONAR CANDIDATOS </strong>
                                    </p>
                                </div>
                    ...
                    <div class="row">
                        <div class="row">
                            <div class="col-lg-3">
                                ...
                                <label class="form-label" for="form-control">TITULO</label>
                                <input type="text" class="form-control" id="titulo" style="border:none;
                            border-bottom-width:3px ; border-bottom-color: var(--bs-gray-900);
                            background: transparent;" value="<?php echo $dado['titulo']?>" readonly>
                        </div>
                              </div>
                             <div class="col-lg-3">
                                 <div class="form-control">
                                <label class="form-label" for="form-control">DATA DE VOTAÇAO</label> 

                                <input type="text" class="form-control" id="data_inicio" style="border:none;
                            border-bottom-width:3px ; border-bottom-color: var(--bs-gray-900);
                            background: transparent;" value="<?php echo $dado['data_inicio']?>" readonly></div>
                              
 </div>
                              <div class="col-lg-3">
<div class="form-control">
                                <label class="form-label" for="form-control">DATA DE VOTA;AO</label> 

                               
                                <input type="text" class="form-control" id="hora_inicio" style="border:none;
                            border-bottom-width:3px ; border-bottom-color: var(--bs-gray-900);
                            background: transparent;" value="<?php echo $dado['hora_inicio']?>" readonly></div>
                             </div>
                            
                               <div class="col-lg-3">
 <div class="form-control">
                                <label class="form-label" for="form-control">HORA DE TERMINO</label>
                                <input type="text" class="form-control" id="hora_final" style="border:none;
                            border-bottom-width:3px ; border-bottom-color: var(--bs-gray-900);
                            background: transparent;" value="<?php echo $dado['hora_final']?>" readonly></div>
                             </div>
                        </div>
                                                <div class="col-lg-7">
                                    <div class="card-header py-3 align-items-center">
                                        <p class="text-primary m-0 fw-bold " style="color: var(--bs-purple);text-align: center;">
                                         ...
                                         <strong> Lista de pessoas elegiveis </strong></p>
                                     </div>
                                     ...
                                     <div class="card-body" id="pessoas_elegiveis">
                                         ...
                                         <strong> CANDIDADTOS REGISTADOS </strong></p>
                                                        </div>
                                                        <div class="card-body" id="lista_candidatos">
