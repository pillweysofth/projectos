...
<body id="page-top">
                        ...
                        <div><a class="btn btn-link nav-link" data-bs-toggle="collapse" aria-expanded="false" aria-controls="collapse-2" href="#collapse-2" role="button" style="font-weight: bold;"><i class="fa fa-wpforms" style="width: 13px;height: 13px;"></i>&nbsp;Questionario</a>
                            <div class="collapse" id="collapse-2">
                                <div class="bg-white border rounded py-2 collapse-inner"><a class="collapse-item" 
                                    href="lista_questionario.php"><i class="fa fa-plus-circle"></i>&nbsp;Participar em questionario</a><a class="collapse-item" href="lista_questionario.php"><i class="fa fa-check-square-o"></i>&nbsp; Ver Resultado de Questionadio</a></div>
                            </div>
                        </div>
                    </li>
                    <hr class="sidebar-divider">
                ...
                <img class="magem" src="img/3.jpg" width="100%" height="100%">
                  <div class="container">
                        <div class="carousel-caption text-start">
                            ...
                            <p><a class="btn btn-lg btn-primary" href="eleicao.php">Ir ao voto</a></p>
                        </div>
                </div>
            </div>
            ...
            <img class="magem" src="img/carousel1.jpg" width="100%" height="100%">
              <div class="container">
                  <div class="carousel-caption">
                    ...
                    <p><a class="btn btn-lg btn-primary" href="#">Ver Questionarios</a></p>
                    </div>
                </div>
        </div>
        <div class="carousel-item">
  ...
  <path d="M8.186 1.113a.5.5 0 0 0-.372 0L1.846 3.5l2.404.961L10.404 2l-2.218-.887zm3.564 1.426L5.596 5 8 5.961 14.154 3.5l-2.404-.961zm3.25 1.7-6.5 2.6v7.922l6.5-2.6V4.24zM7.5 14.762V6.838L1 4.239v7.923l6.5 2.6zM7.443.184a1.5 1.5 0 0 1 1.114 0l7.129 2.852A.5.5 0 0 1 16 3.5v8.662a1 1 0 0 1-.629.928l-7.185 2.874a.5.5 0 0 1-.372 0L.63 13.09a1 1 0 0 1-.63-.928V3.5a.5.5 0 0 1 .314-.464L7.443.184z"/>
                        ...
                        <div class="card-body">
                            ...
                            <p><a href="" class="btn btn-lg btn-primary">SABER MAIS</a></p>
                        </div>
                    </div>
                </div>
